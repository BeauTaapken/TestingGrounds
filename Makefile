...
UNREALROOTPATH = /home/beau/UnrealEngine4
GAMEPROJECTFILE =/mnt/crucial-ssd/UnrealGames/TestingGrounds/TestingGrounds.uproject
...
TARGETS = \
	...
	UE4Server \
	TestingGrounds-Linux-Debug  \
	TestingGrounds-Linux-DebugGame  \
	TestingGrounds-Linux-Shipping  \
	TestingGrounds-Linux-Test  \
	TestingGrounds \
	TestingGroundsEditor-Linux-Debug  \
	TestingGroundsEditor-Linux-DebugGame  \
	TestingGroundsEditor-Linux-Shipping  \
	TestingGroundsEditor-Linux-Test  \
	TestingGroundsEditor\
	configure
...
TestingGrounds-Linux-Debug:
	 $(PROJECTBUILD) TestingGrounds Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

TestingGrounds-Linux-DebugGame:
	 $(PROJECTBUILD) TestingGrounds Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

TestingGrounds-Linux-Shipping:
	 $(PROJECTBUILD) TestingGrounds Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

TestingGrounds-Linux-Test:
	 $(PROJECTBUILD) TestingGrounds Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

TestingGrounds:
	 $(PROJECTBUILD) TestingGrounds Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

TestingGroundsEditor-Linux-Debug:
	 $(PROJECTBUILD) TestingGroundsEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

TestingGroundsEditor-Linux-DebugGame:
	 $(PROJECTBUILD) TestingGroundsEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

TestingGroundsEditor-Linux-Shipping:
	 $(PROJECTBUILD) TestingGroundsEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

TestingGroundsEditor-Linux-Test:
	 $(PROJECTBUILD) TestingGroundsEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

TestingGroundsEditor:
	 $(PROJECTBUILD) TestingGroundsEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
